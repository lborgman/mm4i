...
const SW_VERSION = "0.2.319-chatGPT-Xi"; // Changed version to verify new SW is running
console.log("HEJ", SW_VERSION);
...
const _swLifecycleLoger = () => {
    ...
    self.addEventListener = function (type, listener, ...rest) {
        console.warn(`[SW Lifecycle Diagnostic] addEventListener("${type}") called`);
